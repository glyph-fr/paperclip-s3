...
Also, if your bucket is in another region than the default "US Standard", you must specify the region with the subdomain used by AWS to reach your region, using the command above.

<pre>
  heroku config:add S3_REGION=s3-eu-west-1
</pre>
